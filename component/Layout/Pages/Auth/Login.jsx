        ...
        <div className="relative w-full max-w-md">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-[#d99a58] text-[11px] tracking-[5px] uppercase font-bold">Welcome Back</p>
            </div>
            <h1 className="text-4xl font-black">
              Sign <span className="text-[#d99a58]">In</span>
            </h1>
            <p className="text-white/35 text-sm mt-2">Access your reservations and profile.</p>
          </div>
          ...
          <form className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" className="accent-[#d99a58] w-4 h-4" />
                <span className="text-xs text-white/40">Remember me</span>
              </label>
              <Link
                href="/auth/forgot-password"
                className="text-xs text-[#d99a58] hover:text-[#e8aa68] transition-colors"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <p className="text-center text-sm text-white/35">
            ...
            <Link href="/auth/signup" className="text-[#d99a58] font-bold hover:text-[#e8aa68] transition-colors">
              Create one
            </Link>
          </p>
